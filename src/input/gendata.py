...
Ho = 4500  # depth of ocean (m)
nx = 62    # gridpoints in x
ny = 62    # gridpoints in y
xo = 0.0   # origin in x,y for ocean domain in degrees
yo = 10.0  # (i.e. southwestern corner of ocean domain)
dx = 2     # grid spacing in x (degrees longitude)
dy = 2     # grid spacing in y (degrees latitude)
